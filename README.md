...
| Marketing Engine | Autonomous pipeline (`convex/marketing/`) dropping **3×/week (Tue/Thu/Sat, Riyadh)** with **all content in Arabic**: **18:00** generation (Llama-3 Arabic captions, SD3-medium image, fal.ai Kling workflow video with rotating Arabic pain→value marketing angles) → **19:00** distribution (Composio to X/Facebook/Instagram/LinkedIn + Telegram broadcast to all users, 25 msg/sec) → **24:00** storage cleanup. Dormant until `MARKETING_ENABLED=true`. |
