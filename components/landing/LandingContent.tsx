        ...
        <div className="max-w-5xl mx-auto px-6">
          ...
          <div className="mt-12 grid sm:grid-cols-2 gap-4 max-w-2xl mx-auto">
            <div className="rounded-3xl bg-[#17171c] border border-white/10 p-8 text-center">
              <p className="text-lg font-extrabold">{t('landing.pack500')}</p>
              <p className="mt-1 text-sm text-white/60">{t('landing.pack500d')}</p>
          ...
          <p className="mt-6 text-center text-sm text-white/60">{t('landing.pricingNote')}</p>
